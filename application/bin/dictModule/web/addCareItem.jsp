...
<form id="crmform" class="contentForm" method="post" action="${pageContext.request.contextPath}/crm::/dictModule/action/AddDict.action">
  <fieldset>
    <legend>新增养护品</legend>
     ...
     <tr class="rowClass">
      <td class="colName">养护品编号:</td>
      <td class="detailColVal">
		<input type="text" name="dict_code" id="dict_code"/>
	  </td>
      <td class="colName">养护品名称:</td>
      <td class="detailColVal">
      	 <input type="text" name="dict_value" id="dict_value"/>
	  </td>
	   <td class="colName">养护品价格:</td>
      <td class="detailColVal">
      	 <input type="text" name="dict_other" id="dict_other" class="auto"/>
      	 <input type="hidden" name="dict_type" value="crm_careItemName"/>
