...
<body>
<div id="man_zone">
<form id="crmform" class="queryFrom" action="${pageContext.request.contextPath}/crm::/pointModule/action/DecPointCW.action" method="post">
			<input type="hidden" name="startIndex" value="0"/>
			<input type="hidden" name="endIndex" value="9"/>
			<fieldset id="formFiled">
			  <legend>财务兑换积分</legend>
              <table cellspacing="2" cellpadding="0">
                      ...
                      <td class="colName">兑换积分:</td>
                      <td class="detailColVal">
                      	<input type="text" name="pps" id="pps" value="${pps}"/>
                      </td>
                      <td class="colName">说明:</td>
                      <td class="detailColVal">
                      	<input type="text" name="p_note" id="p_note" value="${p_note}"/>
                      </td>
                      <!-- 
