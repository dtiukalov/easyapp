...
<script type="text/javascript">
		$(function() { 
			$("#paginate").saturnTablePaginate({
				...
				action:'${pageContext.request.contextPath}/crm::/pointModule/action/PointListByVin.action',
				form:'crmform',
				percount:10
			});
		});
...
<body>
<div id="man_zone"> 
		<form id="crmform" class="queryFrom" action="${pageContext.request.contextPath}/crm::/pointModule/action/PointListByVin.action" method="post">
        ...
        <table class="optDiv">
			<tr>
				...
				<td style="width:25%;">&nbsp;<!-- <div class="optAdd"><a href="javascript:addCareItem();">新增</a></div> --></td>
			</tr>
		</table>
    	<div class="tbDiv">
     		<div style="width:100%;">
             ...
             <div id="dataDiv" style="width:100%;">
			   <table id="dataTb" cellspacing="0" cellpadding="0">
                 <c:forEach items="${addresult}" var="var" varStatus="sta">
                 	 <tr>
                 	 <td>
                        <div id="vin_${sta.index}" style="width:100%;padding:0;"></div>
                        <script type="text/javascript">getPL("vin_"+${sta.index},'${var.p_title}');</script>
                        </td>
