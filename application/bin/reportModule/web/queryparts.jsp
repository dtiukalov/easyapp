...
<script type="text/javascript">
		function QueryPart(){
			$('#exportForm')[0].action = "<%=request.getContextPath()%>/crm::/reportModule/action/QueryNewParts.action";
			$('#exportForm')[0].submit();
		}
		
		
</script> 
<title>售后前台--精品金额</title>
</head>
<body>
<div id="man_zone">
	<form id="crmform" class="queryFrom" action="${pageContext.request.contextPath}/crm::/reportModule/action/QueryParts.action">
		<fieldset>
		  <legend>售后前台--精品金额</legend>
    ...
    <table class="optDiv"  style=''>
		<tr>
			...
			<td><div id="paginate"><a href="javascript:QueryPart();">导出</a></div></td>
		</tr>
	</table>
           	...
           	<tr>
				...
				<%
					...
					for(int i=0; i<result.size(); i++){
						...
						if(sumid.get("sumdayparts")!=null){
							j+= Float.parseFloat(sumid.get("sumdayparts").toString());
						}
						if(sumid.get("summonparts")!=null){
							s+= Float.parseFloat(sumid.get("summonparts").toString());
						}
					}
					out.print(j);
				%>
