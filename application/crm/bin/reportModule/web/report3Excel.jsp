...
<%
Object obj = (Object)session.getAttribute("report3");
//session.removeAttribute("report3");
if (obj != null){
	String[][] report1 = (String[][])obj;
	
    String filename= request.getParameter("datetime") + "售后前台业务分析报表(节余机油)";
	...
	cell2.setCellValue(request.getParameter("jycount"));	
