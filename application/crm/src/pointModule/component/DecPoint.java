...
public class DecPoint extends DefaultComponent {
	@Override
	public void execute(IParameterContext parameterContext) throws Exception {
		...
		//兑换项主键
		String pr_id = (String)parameterContext.getParameterValue(1);
		//兑换数量
		...
		//兑换规则积分
		//int pr_point=0;
		if(vin!=null&&!"".equals(vin)&&pr_id!=null&&!"".equals(pr_id)&&pnum!=null&&!"".equals(pnum)){
			//会得兑换项
			...
			if(pr_rs!=null&&pr_rs!=null){
				...
				pdao.insertP(p_title,vin,"",ppt,ppt,p_date,2,"");
			}
		}
	}
}