...
<script type="text/javascript">
		function QueryPart(){
			$('#exportForm')[0].action = "<%=request.getContextPath()%>/crm/reportModule/web/report5Excel.jsp";
			$('#exportForm')[0].submit();
		}
...
<div id="man_zone">
              ...
              <table cellspacing="0" cellpadding="0">
                   <tr>                    
                     ...
                     <td class="detailColVal" colspan="10">
                     	<input type="hidden" name="typez" id="typez" value="jp">
	...
	if (obj != null){
		...
		session.setAttribute("report5",report1);
	%>
			...
			<tr>
           	...
           	<tr>
				...
				for(int i=0;i<report1[2].length;i++){
					%>
					<td><%=Double.parseDouble(report1[2][i]) %></td>
					<%
				}
				%>
           	</tr>
