...
<html>
	<head>
		...
		List<String> KaufteileNum = (List)form.get("fv9KaufteileNum");
		...
		String fv9KaufteileNum = Web.getNumberListStr(KaufteileNum);
			...
			<div id="content">
				<div id="chart" style="width: 850px; height: 400px; margin: 0 auto"></div>
					...
					if(size > 0){
						...
						double totalWidth = 600.0;//总长度是 750px 
				...
				<div id="meilstein" style="width: <%=sum%>px; height: 30px; margin-left: 129px; text-align: center; overflow: hidden; ">
