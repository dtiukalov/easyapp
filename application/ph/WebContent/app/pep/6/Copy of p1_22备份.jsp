...
<!-- saved from url=(0086)http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/ -->
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>33TimeLine</TITLE>
<META content="text/html; charset=utf-8" http-equiv=content-type>
<META content="IE=7, IE=9" http-equiv=X-UA-Compatible>
<META content=no http-equiv=imagetoolbar>
<META name=MSSmartTagsPreventParsing content=true><LINK rel=stylesheet 
type=text/css 
href="timeline/latest.css" 
media=screen><!--[if IE 6]><link type="text/css" rel="stylesheet" href="timeline/screen.ie6.css" /><![endif]--><!--[if IE 7]><LINK 
rel=stylesheet type=text/css 
href="timeline/screen.ie7.css"><![endif]--><!--[if IE 8]><link type="text/css" rel="stylesheet" href="timeline/screen.ie8.css" /><![endif]-->
<SCRIPT type=text/javascript 
src="timeline/jquery-1.5.min.js"></SCRIPT>

<SCRIPT type=text/javascript 
src="timeline/jquery.mousewheel.js"></SCRIPT>
<!--[if IE]>
<SCRIPT type=text/javascript 
src="timeline/excanvas.compiled.js"></SCRIPT>
<![endif]-->
<SCRIPT type=text/javascript 
src="timeline/latest.js"></SCRIPT>
<BODY>
<DIV id=console></DIV>
<DIV id=tl-container>
<DIV class="tl-data tl-data-userId"></DIV>
<DIV class="tl-data tl-data-secret-userId"></DIV>
<DIV id=tl-image-preloader><IMG alt="" 
src="timeline/black-opacity-95.png"> 
<IMG alt="" 
src="timeline/Day_of_Anger_marchers_in_street.jpg"> 
</DIV>
<DIV id=tl-header>
<DIV class=main-logo><A href="http://www.tiki-toki.com/">Tiki-Toki</A></DIV>
<H1 class=tl-main-title>334555554The Fight for Democracy in the Middle East</H1>
<UL class=main-menu>
  <LI><A id=menu-item-about-this-timeline 
  href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">About 
  this timeline</A> </LI>
  <LI><A id=menu-item-create-your-own-timeline href="http://www.tiki-toki.com/" 
  target=_top>Create a timeline</A> </LI>
  <LI><A 
  href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#" 
  popupId="ajk-pop-down-panel-contact-us">Contact</A> </LI>
  <LI class=menu-item-logged-out><A 
  href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#" 
  popupId="ajk-pop-down-panel-login">Login</A> </LI>
  <LI class="last menu-item-logged-out"><A id=pop-down-panel-sign-up-menu-item 
  href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#" 
  popupId="ajk-pop-down-panel-sign-up">Free sign up</A> </LI>
  <LI class="last menu-item-logged-in"><A 
  href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Logout</A> 
  </LI></UL></DIV>
<DIV class=tl-timeline-info>
<H2>With inspiring bravery and determination, the people of the Middle East are 
demanding to have their voices heard. We record the key events in their 
hopefully successful journey to democracy in this interactive multimedia 
timeline.</H2>
<P class=tl-ah-about-text>You can navigate the timeline by dragging the 
viewfinder at the bottom of the timeline. You can also click anywhere in the 
time scale at the bottom to jump quickly to that point in time. ;xNLx;;xNLx;We 
have categorised events by country. Each country has its own colour: sky blue 
for Tunisia, red for Egypt, pink for Libya and orange for Bahrain. For further 
information (including videos and images) about a particular event, click the 
'more' button.;xNLx;;xNLx;The information for this timeline has been obtained 
from numerous sources, including Al Jazeera, Wikipedia, Flickr and YouTube. 
Copyright over the images and videos on this timeline belongs with their 
respective owners.</P></DIV>
<DIV id=tl-stage-holder><!--<img src="timeline/assets/ui/empty-image2.gif" alt="" id="tl-stage-image" />-->
...
<DIV class=tl-mib-image-holder><IMG 
src="timeline/empty-image.gif"> 

<DIV class=tl-mib-image-mask><SPAN></SPAN></DIV></DIV>
<H3 class=tl-mib-headline></H3>
<DIV class=tl-mib-content>
<P></P></DIV></DIV></DIV></DIV>
<DIV id=tl-slider-holder>
<DIV id=tl-slider-scale-holder>
<DIV id=tl-slider-scale><CANVAS class=tl-scale-canvas height="52" 
width="5000"></CANVAS>
<DIV id=tl-slider-scale-times-holder></DIV>
<DIV id=tl-slider-markers-holder></DIV></DIV></DIV>
...
<DIV class="tlsd-corner tlsd-c-br"></DIV></DIV></DIV></DIV></DIV>
<DIV id=tl-footer></DIV>
<DIV id=ajk-pop-down-panel-login 
class="ajk-pop-down-panel ajk-pop-down-panel-align-top ajk-pop-down-panel-align-right-top">
<DIV class=top></DIV>
...
<FORM>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-chars">3-20</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <INPUT 
class=ajk-verifier-control value=Username name=username> </DIV>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-chars">3-20</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <INPUT 
class=ajk-verifier-control value=Password name=tikitokipassword> </DIV><A 
class=forgotten-password 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Forgotten 
login details?</A> 
<DIV class=verification-messages>
<P class=ajk-verifier-error-message>Please check details and try again</P>
<P class=ajk-verifier-submitting-message>Checking details</P></DIV><A 
class="rt-button-3 ajk-verifier-submit" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Login</A> 

<DIV class=tl-clear></DIV></FORM><A class=close 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">close</A> 
</DIV><!-- /fp-block -->
<DIV class="fp-block fp-block-1 ajk-verifier">
<H3>Forgotten login details</H3>
<P>Enter your email and we'll send you your username and a new password.</P>
<FORM>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-format">email</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">Please enter a valid email 
address</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <INPUT 
class=ajk-verifier-control value="Enter email" name=email> </DIV><A 
class="rt-button-3 ajk-verifier-submit" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Submit</A> 
<A class="rt-button-3 ajk-pd-back-to-start" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Back</A> 

<DIV class=verification-messages>
<P class=ajk-verifier-error-message>Email not in database</P></DIV>
<DIV class=tl-clear></DIV></FORM><A class=close 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Close</A> 
</DIV><!-- /fp-block -->
<DIV class="fp-block fp-block-2 ajk-verifier">
<H3>Sending/checking email</H3>
<P>We are in the process of checking your details/sending you an email. This may 
take a few seconds, so please be patient.</P>
<DIV class=tl-clear></DIV><A class=close 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Close</A> 
</DIV><!-- /fp-block -->
<DIV class="fp-block fp-block-3 ajk-verifier">
<H3>Email sent</H3>
<P>We have sent you an email with your username and a new password. When you 
have logged in, you can change your password in the account tab.</P><A 
class="rt-button-3 ajk-pd-back-to-start" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Back</A> 

<DIV class=tl-clear></DIV><A class=close 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Close</A> 
</DIV><!-- /fp-block --></DIV><!-- /fp-stage --></DIV><!-- /fp-carousel --></DIV></DIV>
<DIV class=bottom></DIV></DIV>
<DIV id=ajk-pop-down-panel-sign-up 
class="ajk-pop-down-panel ajk-pop-down-panel-align-top ajk-pop-down-panel-align-right-top-2">
<DIV class=top></DIV>
<DIV class=content-holder>
<DIV class=content>
<DIV class=fp-carousel>
...
<DIV class="fp-block fp-block-0 ajk-verifier">
<H3>Sign up</H3>
<P>Signing up takes less than a minute - you'll be creating your first timeline 
in almost no time.</P>
<FORM>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-chars">3-20</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">Username must be at least three 
characters</SPAN> <INPUT class=ajk-verifier-control value="Enter username" 
name=username> </DIV>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-format">email</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">Please enter a valid email 
address</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <INPUT 
class=ajk-verifier-control value="Enter email" name=email> </DIV>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-chars">3-20</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">Password must be at least three 
characters</SPAN> <INPUT class=ajk-verifier-control value="Enter password" 
name=tikitokisignuppassword> </DIV>
<P>If you have been given a class code, enter it below:</P>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-chars">0-50</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-hide-default-value">true</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">Optional. Code your teacher gave 
you</SPAN> <INPUT class=ajk-verifier-control value="Enter class code" 
name=pupilClassCode> </DIV>
<DIV class="ajk-verifier-field ajk-verifier-field-checkbox"><SPAN 
class="ajk-verifier-data ajk-verifier-value-options">on</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">You must agree to our terms to 
sign up</SPAN> 
<DIV class=rt-mp-checkbox><SPAN class=ajk-verifier-control 
type="ajk-custom-checkbox" name="agree">off</SPAN>I agree to <A 
href="http://www.tiki-toki.com/termsandconditions" target=_blank>terms &amp; 
conditions</A> </DIV></DIV>
<DIV class=verification-messages>
<P class=ajk-verifier-error-message>Please check details and try again</P>
<P class=ajk-verifier-submitting-message>Checking details</P></DIV>
<DIV class=verification-messages>
<P class=ajk-verifier-tooltip-displayer>test</P></DIV><A 
id=tl-main-sign-up-button class="rt-button-3 ajk-verifier-submit" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Sign 
up</A> 
<DIV class=tl-clear></DIV></FORM><A class=close 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Close</A> 
</DIV><!-- /fp-block -->
...
<P>Congratulations, you are now a signed up member of Tiki-Toki, the best online 
service for creating beautiful interactive timelines.</P>
<P>Click the below button to log in and get started creating your first 
timeline!</P>
<P>If you do not already have a Flickr account, we recommend that you sign up <A 
href="http://www.flickr.com/">here</A>. Flickr is the best way of sharing photos 
on the web and the best way of using your photos on Tiki-Toki.</P><A 
class="rt-button-3 tl-signup-auto-login-button" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Log 
in</A> <A class=close 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Close</A> 
</DIV></DIV><!-- /fp-stage --></DIV><!-- /fp-carousel --></DIV></DIV>
<DIV class=bottom></DIV></DIV>
<DIV id=ajk-pop-down-panel-contact-us 
class="ajk-pop-down-panel ajk-pop-down-panel-align-top ajk-pop-down-panel-align-right-top">
<DIV class=top></DIV>
<DIV class=content-holder>
<DIV class=content>
<H3>Contact us</H3>
<P>We'd love to hear from you. So if you want to ask us any questions, offer 
feedback on the site or would like to buy the professional version of our 
software and host it on your site, please drop us a line.</P>
<P>We can be contacted by email at: <A 
href="mailto:hello@tiki-toki.com">hello@tiki-toki.com</A>.</P>
<P>You can also follow us on twitter at <A 
href="http://twitter.com/tiki_toki">twitter.com/tiki_toki</A>.</P>
<P>If you are having any problems with Tiki-Toki, please contact us as at: <A 
href="mailto:help@tiki-toki.com">help@tiki-toki.com</A></P>
<DIV class=tl-clear></DIV><A class=close 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Close</A> 
</DIV></DIV>
<DIV class=bottom></DIV></DIV>
<DIV id=ajk-panel-secret-login 
class="ajk-pop-down-panel ajk-pop-down-panel-no-arrow">
<DIV class=top></DIV>
<DIV class=content-holder>
<DIV class="content ajk-verifier">
<H3>Edit this timeline</H3>
<P>Enter your name and the secret word given to you by the timeline's owner.</P>
<FORM>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-chars">3-20</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">Name must be at least three 
characters</SPAN> <INPUT class=ajk-verifier-control value=Name name=nickname> 
</DIV>
<DIV class="input-holder ajk-verifier-field"><SPAN 
class="ajk-verifier-data ajk-verifier-chars">3-20</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-not-default-value">true</SPAN> <SPAN 
class="ajk-verifier-data ajk-verifier-tooltip">You need a secret word to edit 
this timeline</SPAN> <INPUT class=ajk-verifier-control value="Secret word" 
name=secret> </DIV>
<DIV class=verification-messages>
<P class=ajk-verifier-submitting-message>Checking details</P>
<P class=ajk-verifier-tooltip-displayer>test</P></DIV>
<DIV class=verification-messages>
<P class=ajk-verifier-error-message>Please check details and try 
again</P></DIV><A class="rt-button-3 ajk-verifier-submit" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Go</A> 
...
<UL class=tl-ch-media-list>
  ...
  (<SPAN>1</SPAN>)</A> </LI></UL><A class=tl-ch-close-content 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#">Close</A> 

<H5 class=tl-ch-panel-date-display>10th August 2010</H5></DIV>
...
<DIV class=tl-g-gallery-controls><A class=tl-g-gallery-control-left 
...
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#"></A></DIV></DIV></DIV>
<DIV class=tl-g-thumb-holder>
<DIV class=tl-g-thumb-stage></DIV><A class=tl-g-thumb-control-left 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#"></A><A 
class=tl-g-thumb-control-right 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#"></A></DIV></DIV><!-- /tl-gallery --></DIV>
...
<DIV class=tl-ch-extra-info-text></DIV><A 
class="tl-ch-full-story-link rt-button-medium rt-button-medium-long" 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#" 
target=_top>Read full story</A> </DIV>
<DIV class=ajk-cs-carousel-scroll-holder><A class=ajk-cs-up-arrow 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#"></A><A 
class=ajk-cs-down-arrow 
href="http://www.tiki-toki.com/timeline/entry/55/The-Fight-for-Democracy-in-the-Middle-East/#"></A>
<DIV class=ajk-cs-scroll-bar><SPAN></SPAN></DIV></DIV></DIV></DIV></DIV></DIV>
<DIV class=tl-ch-video-content>
<DIV class=tl-ch-vc-inner></DIV></DIV></DIV></DIV></DIV>
...
<P class=tl-ch-selected-story-num>x1 of x2 stories</P><A class=tl-ch-prev-story 
href="#"></A><A 
class=tl-ch-next-story 
href="#"></A></DIV><A 
class="tl-ch-close-video rt-button-3 rt-button-3-long" 
...
var TLTimelineData = {
	...
	stories:[{
		...
		startDate:"2010-12-28 00:00:00",
		endDate:"2010-12-28 00:00:00",
