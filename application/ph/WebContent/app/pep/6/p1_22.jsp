...
<HEAD>
<TITLE>3443TimeLine</TITLE>
<META content="text/html; charset=utf-8" http-equiv=content-type>
<META content="IE=7, IE=9" http-equiv=X-UA-Compatible>
<META content=no http-equiv=imagetoolbar>
<META name=MSSmartTagsPreventParsing content=true>
<LINK rel=stylesheet type=text/css href="timeline/latest.css"
	media=screen>
<!--[if IE 6]><link type="text/css" rel="stylesheet" href="timeline/screen.ie6.css" /><![endif]-->
<!--[if IE 7]><LINK 
rel=stylesheet type=text/css 
href="timeline/screen.ie7.css"><![endif]-->
<!--[if IE 8]><link type="text/css" rel="stylesheet" href="timeline/screen.ie8.css" /><![endif]-->
<SCRIPT type=text/javascript src="timeline/jquery-1.5.min.js"></SCRIPT>

<SCRIPT type=text/javascript src="timeline/jquery.mousewheel.js"></SCRIPT>
<!--[if IE]>
<SCRIPT type=text/javascript 
src="timeline/excanvas.compiled.js"></SCRIPT>
<![endif]-->
<SCRIPT type=text/javascript src="timeline/latest.js"></SCRIPT>
<BODY>
	<DIV id=console></DIV>
	<DIV id=tl-container>
		...
		<DIV id=tl-image-preloader>
			<IMG alt="" src="timeline/black-opacity-95.png"> <IMG alt=""
		...
		<DIV id=tl-stage-holder>
			<!--<img src="timeline/assets/ui/empty-image2.gif" alt="" id="tl-stage-image" />-->
			...
			<DIV class=tl-main-intro-block>
				<DIV class=tl-mib-inner>
					<DIV class=tl-mib-image-holder>
						<IMG src="timeline/empty-image.gif">
					...
					<DIV class=tl-mc-bottom-left>
						<DIV class=tl-mc-footer-content>
							<DIV class="tl-ch-bc-inner tl-ch-next-prev-story">
								...
								<A class=tl-ch-prev-story href="#"></A><A class=tl-ch-next-story
									href="#"></A>
							</DIV>
...
//			backgroundImage : "http://farm6.static.flickr.com/5051/5452904725_90d7e0eea9_b.jpg",
			backgroundImage : "http://localhost:8080/<%=request.getContextPath()%>/app/pep/images/timeline_bg.jpg",
			introImageCredit : "",
