...
import com.saturn.ph.views.AbstractWelcomeComposite;

public class TableComposite extends AbstractWelcomeComposite {
	private Browser browser;
	private String HomeUrl = "http://localhost:7001/tc/webclient";

	public TableComposite(Composite paramComposite, String paramString) {
		if (paramString != null)
	...
	public void initialize(Composite paramComposite) {
		...
		localText.addListener(14, new Listener() {
			public void handleEvent(Event paramEvent) {
				TableComposite.this.browser.setUrl(localText.getText());
			}
		});
		...
		localToolItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent paramSelectionEvent) {
				TableComposite.this.browser
						.setUrl(TableComposite.this.HomeUrl);
			}
		});
		...
		localToolItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent paramSelectionEvent) {
				TableComposite.this.browser.back();
			}
		});
		localToolItem = new ToolItem(localToolBar, 0);
		...
		localToolItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent paramSelectionEvent) {
				TableComposite.this.browser.forward();
			}
		});
		localToolItem = new ToolItem(localToolBar, 0);
		...
		localToolItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent paramSelectionEvent) {
				TableComposite.this.browser.refresh();
			}
		});
		localToolItem = new ToolItem(localToolBar, 0);
		...
		localToolItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent paramSelectionEvent) {
				TableComposite.this.browser.stop();
			}
		});
		localToolItem = new ToolItem(localToolBar, 0);
		...
		localToolItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent paramSelectionEvent) {
				...
				TableComposite.this.browser.execute(str);
			}
		});
