	...
	<script type="text/javascript">
		$(function() {
			...
			$('#queryTable').datagrid({
				...
				url : '<%=request.getContextPath()%>/app/car/bookcar/list.action',
				idField : 'id',//唯一标识列
				sortName : 'id',
				sortOrder : 'desc',
				remoteSort : true,
				...
				columns : [ [ {
					...
					formatter : function(value, rec) {
						return '<span><a href="<%=request.getContextPath()%>/app/car/bookcar/state.action?state=' + rec.id + '">' + rec.stateName +'</a>';
					}
				}, {
					field : 'opt',
					title : '操作',
	...
	<div id="panel" class="easyui-panel" title="查询条件"
		...
		<form id="queryForm" method="post">
			<table>
				<tr align="right">
					<td>目录标识:</td>
					<td align="left"><select id="cid" name="cid" type="text"></select></td>
					<td>品牌:</td>
