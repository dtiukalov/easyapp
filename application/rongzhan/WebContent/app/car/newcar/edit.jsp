...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#cid').combogrid("setValue", '${newcar.cid}');
	});
...
<body>
	<div id="panel" class="easyui-panel" title="修改新车"
		...
		<form id="editForm"
			action="<%=request.getContextPath()%>/app/car/newcar/update.action"
			method="post">
			<table>
				<tr><td>
			<table class="table-form">
				...
				<tr>
					...
					<td><input id="image" name="image" type="text" value="${newcar.image}"></input></td>
