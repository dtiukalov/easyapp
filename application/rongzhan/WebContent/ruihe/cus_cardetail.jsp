...
<body style="margin:0px; padding:0px;">
  ...
  <tr>
    <td><table width="715" border="0" cellspacing="0" cellpadding="0">
      <tr>
    <td height="25px">您所在的位置：<a href="index.jsp"><span style="color:#F00">首页</span></a>&nbsp;|&nbsp;<a href="<%=WebUtils.getLink("ruihe.sall", null)%>">销售服务</a>&nbsp;>&nbsp;<a href="cus_cars.jsp?cid=ruihe.sall&aid=ruihe.sall.new">新车报价</a></td>
  </tr>
</table>
...
<table width="980px" border="1" cellpadding="0" cellspacing="0" class="tablebase" bordercolordark="#FFFFFF">
		 <tr align="center">
		   ...
		   <td width="135.14286px" class="trtitle">
				<strong style="font-size:14px;"> 东风本田&nbsp;CRV</strong> 
			</td>
			 <td width="135.14286px" class="trtitle">
				<strong style="font-size:14px;"> 东风本田&nbsp;CRV</strong> 
			</td>
		 ...
		 <tr align="center" >
		  ...
		  <tr align="center">
							<td class="trtitle" onclick="test(this,'cheshen')">
								<strong style="font-size:12px; color:#a6762c;">车身规格</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		...
		<tr align="center" tabName="cheshen">
		 ...
		 <tr align="center">
							<td class="trtitle" onclick="test(this,'test1')">
								<strong style="font-size:12px; color:#a6762c;">性能参数</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		...
		<tr align="center">
							<td class="trtitle" onclick="test(this,'test2')">
								<strong style="font-size:12px; color:#a6762c;">发动机规格</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		...
		<tr align="center">
							<td class="trtitle" onclick="test(this,'test3')">
								<strong style="font-size:12px; color:#a6762c;">系统结构</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		 ...
		 <tr align="center">
							<td class="trtitle" onclick="test(this,'test4')">
								<strong style="font-size:12px; color:#a6762c;">安全/防盗</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		...
		<tr align="center" tabName="test4">
		 ...
		 <tr align="center" tabName="test4">
		  ...
		  <tr align="center">
							<td class="trtitle" onclick="test(this,'test5')">
								<strong style="font-size:12px; color:#a6762c;">座椅/方向盘</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		 ...
		 <tr align="center" tabName="test5">
		  ...
		  <tr align="center">
							<td class="trtitle" onclick="test(this,'test6')">
								<strong style="font-size:12px; color:#a6762c;">音响控制系统</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		 ...
		 <tr align="center">
							<td class="trtitle" onclick="test(this,'test7')">
								<strong style="font-size:12px; color:#a6762c;">空调系统</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
		 ...
		 <tr align="center">
							<td class="trtitle" onclick="test(this,'test8')">
								<strong style="font-size:12px; color:#a6762c;">外 观</strong>
							</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
							<td class="trtitle">&nbsp;&nbsp;</td>
