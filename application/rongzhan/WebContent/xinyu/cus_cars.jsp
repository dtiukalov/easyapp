...
<div id="content">  
  ...
  <tr>
  	<td width="102" class="<%="car.yiqivw.suteng".equals(model)||model==null||"".equals(model)?"biaoge":"biaogeh" %>" onclick="getCarByModule('car.yiqivw.suteng');">速腾</td>
   <td width="102" class="<%="car.yiqivw.jieda".equals(model)?"biaoge":"biaogeh" %>" onclick="getCarByModule('car.yiqivw.jieda');">捷达</td>
   <td width="102" class="<%="car.yiqivw.maiteng".equals(model)?"biaoge":"biaogeh" %>" onclick="getCarByModule('car.yiqivw.maiteng');">迈腾</td>
   <td width="102" class="<%="car.yiqivw.baolai".equals(model)?"biaoge":"biaogeh" %>" onclick="getCarByModule('car.yiqivw.baolai');">宝来</td>
   <td width="102" class="<%="car.yiqivw.gaoerfu".equals(model)?"biaoge":"biaogeh" %>" onclick="getCarByModule('car.yiqivw.gaoerfu');">高尔夫</td>
   <td width="102" class="<%="car.yiqivw.gti".equals(model)?"biaoge":"biaogeh" %>" onclick="getCarByModule('car.yiqivw.gti');">GTI</td>
   <td width="102" class="<%="car.yiqivw.cc".equals(model)?"biaoge":"biaogeh" %>" onclick="getCarByModule('car.yiqivw.cc');">CC</td>
  </tr>
</table>
  ...
  <table class="tableline" cellpadding="0" cellspacing="1">
    ...
    <%
     			for (int i = 0; i < cars.size(); ++i) {
			      ...
			      <td height="82" style="border-top: dashed thin #ababab;border-width:1px;"><img src="<%=car.getImage()!=null?car.getImage():"images/car.gif" %>" width="150" height="86" /></td>
     		...
     		%>
       		<tr align="center" height="98px" bgcolor="<%=bgcolor%>">
		      <td ><span style="border-top: dashed thin #ababab;border-width:1px;"><img src="<%=car.getImage()!=null?car.getImage():"images/car.gif" %>" width="150" height="86" /></span></td>
