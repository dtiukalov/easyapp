...
if("car.xuefulan.gconvertible".equals(model)){
%>
GConvertible
<%
}else if("car.xuefulan.gcoupe".equals(model)){
%>
G Coupe
<%
}else if("car.xuefulan.gsedan".equals(model)){
%>
G Sedan
<%
}else if("car.xuefulan.m".equals(model)){
%>
M
<%
}else if("car.xuefulan.ex".equals(model)){
%>
EX
<%
}else if("car.xuefulan.fx".equals(model)){
%>
FX
<%
}else if("car.xuefulan.qx".equals(model)){
%>
QX
<%
}else{
