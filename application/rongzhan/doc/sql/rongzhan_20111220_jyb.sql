...
INSERT INTO `car_bookcar` (`id`, `cid`, `brand`, `brandName`, `model`, `modelName`, `series`, `seriesName`, `license`, `phone`, `type`, `typeName`, `text`, `bookTime`, `createTime`, `state`, `stateName`) VALUES 
  ...
  (14,'ruihe','car.dongfenghonda','东风本田','car.dongfenghonda.crv','CRV','car.dongfenghonda.crv.1','系列一','','3456','bookcar.type.bookcar','置换','网上热个晚上大概','','2011-12-20 07:58:18','bookcar.state.false','未确认'),
...
INSERT INTO `web_content` (`id`, `name`, `english`, `path`, `parentId`, `sort`, `hasShow`, `hasShowName`, `mode`, `modeName`) VALUES 
  ...
  ('dongri.sall','销售服务','Sall','','dongri',126,'visible.true','显示','content.mode.one','单项'),
  ...
  ('dongri.book','预约服务','Book','','dongri',130,'visible.true','显示','content.mode.one','单项'),
  ...
  ('dongri.sall.new','新车报价','NewCar','','dongri.sall',138,'visible.true','显示','content.mode.one','单项'),
  ...
  ('dongri.book.drive','试乘预约','Drive','','dongri.book',151,'visible.true','显示','content.mode.one','单项'),
  ('dongri.book.repair','维修预约','Repair','','dongri.book',152,'visible.true','显示','content.mode.one','单项'),
  ('dongri.book.maintain','保养预约','Maintain','','dongri.book',153,'visible.true','显示','content.mode.one','单项'),
  ('dongri.book.buy','订车预约','Buy','','dongri.book',154,'visible.true','显示','content.mode.one','单项'),
  ...
  ('suixin.sall','销售服务','Sall','','suixin',190,'visible.true','显示','content.mode.one','单项'),
  ...
  ('suixin.book','预约服务','Book','','suixin',194,'visible.true','显示','content.mode.one','单项'),
  ...
  ('suixin.sall.new','新车报价','NewCar','','suixin.sall',202,'visible.true','显示','content.mode.one','单项'),
  ...
  ('suixin.book.drive','试乘预约','Drive','','suixin.book',215,'visible.true','显示','content.mode.one','单项'),
  ('suixin.book.repair','维修预约','Repair','','suixin.book',216,'visible.true','显示','content.mode.one','单项'),
  ('suixin.book.maintain','保养预约','Maintain','','suixin.book',217,'visible.true','显示','content.mode.one','单项'),
  ('suixin.book.buy','订车预约','Buy','','suixin.book',218,'visible.true','显示','content.mode.one','单项'),
  ...
  ('xingbang.sall','销售服务','Sall','','xingbang',222,'visible.true','显示','content.mode.one','单项'),
  ...
  ('xingbang.book','预约服务','Book','','xingbang',226,'visible.true','显示','content.mode.one','单项'),
  ...
  ('xingbang.sall.new','新车报价','NewCar','','xingbang.sall',234,'visible.true','显示','content.mode.one','单项'),
  ...
  ('xingbang.book.drive','试乘预约','Drive','','xingbang.book',247,'visible.true','显示','content.mode.one','单项'),
  ('xingbang.book.repair','维修预约','Repair','','xingbang.book',248,'visible.true','显示','content.mode.one','单项'),
  ('xingbang.book.maintain','保养预约','Maintain','','xingbang.book',249,'visible.true','显示','content.mode.one','单项'),
  ('xingbang.book.buy','订车预约','Buy','','xingbang.book',250,'visible.true','显示','content.mode.one','单项'),
