...
<script type="text/javascript">
		$(function() { 
			$("#paginate").saturnTablePaginate({
				...
				action:'${pageContext.request.contextPath}/crm::/dictModule/action/QueryWorkerList.action',
				form:'crmform',
				percount:10
			});
		});
		...
		function addWorker(){
			window.open("<%=request.getContextPath()%>/crm/dictModule/web/addWorker.jsp", "", "height=300, width=600, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
		}
</script> 
<title>维修人员管理</title>
</head>
<body>
<div id="man_zone">
		<form id="crmform" class="queryFrom" method="post" action="${pageContext.request.contextPath}/crm::/dictModule/action/QueryWorkerList.action">
			<input type="hidden" name="startIndex" value="0"/>
			<input type="hidden" name="endIndex" value="9"/>
			<fieldset id="formFiled">
			  <legend>维修人员管理</legend>
        ...
        <table class="optDiv">
			<tr>
				...
				<td style="width:15%;"><div class="optAdd"><a href="javascript:addWorker();">新增</a></div>
			</tr>
		</table>
    	<div class="tbDiv">
     		<div style="width:100%;">
