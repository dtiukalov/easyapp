...
<script type="text/javascript">
	$(function() { 
		$('#serv_servstaff').selectDict({type:'crm_waiter',id:'serv_servstaff'});
		$('#serv_servmetalworker').selectDict({type:'crm_worker',id:'serv_servmetalworker'});
		$('#serv_servpaintworker').selectDict({type:'crm_worker',id:'serv_servpaintworker'});
		$('#serv_servelecworker').selectDict({type:'crm_worker',id:'serv_servelecworker'});
	...
	$(function(){    
	    ...
	    $("input[name='jytype']:checked").click();
	    ...
	    $('.auto').bind('blur',function(){
			...
			//转账
			//var serv_servcashexp = parseNum($('#serv_servcashexp').val());
			//$('#serv_servtransfer').val((serv_servamountexp - serv_servcashexp).toFixed(2));
			//现金消费
					...
					serv_servorderid:{
						remote:{
						    ...
						    data: {
						        ...
						        serv_servorderid: function () {
						            return $('#serv_servorderid').val();
						        }
						    }
	...
	function openwin() {
		...
		if(carvin!=''){ 
			window.open ("${pageContext.request.contextPath}/crm::/carModule/action/QueryCarByVin.action?carvin="+carvin, "carDetailWindow", "height=600, width=1000, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no"); 
		}else{
			window.open ("${pageContext.request.contextPath}/crm::/carModule/action/QueryCarInfo.action?startIndex=0&endIndex=9", "carWindow", "height=600, width=1000, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no"); 
		}
	} 
...
function addPartsWin(){
	var carvin =  $('#serv_carvin').val();
	var partsintime = $('#serv_servintime').val();
	var partsouttime = $('#serv_servouttime').val();
	var partsstaff = $('#serv_servstaff').val();
	window.open ("${pageContext.request.contextPath}/crm/partsModule/web/addParts.jsp?carvin="+carvin+"&partsstaff="+partsstaff+"&partsintime="+partsintime+"&partsouttime="+partsouttime, "", "height=600, width=1000, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 
}
function addCareWin(){
...
<body>
<div id="man_zone">
<form id="crmform" class="contentForm" method="post" action="${pageContext.request.contextPath}/crm::/serviceModule/action/AddService.action?startIndex=0&endIndex=9">
<fieldset>
<legend>新增维修</legend>
...
<tr class="rowClass">
      ...
      <input type="text" name="serv_servnotes" id="serv_servnotes" value="" style="width:400px;"/>
      </td>
    </tr>
    <tr class="rowClass">
      <td class="colName">工单号:</td>
      <td class="detailColVal">
          <input type="text" name="serv_servorderid" id="serv_servorderid"/>
	  </td>
      ...
      <td class="detailColVal">
      	 <input type="text" name="serv_carvin" id="serv_carvin" onblur="javascript:getMaintainInfo();"/>
    ...
    <tr class="rowClass">
      ...
      <td class="detailColVal">
      	  <input type="text" name="serv_servintime" id="serv_servintime" onfocus="minuteCalender(this)" onblur="fillMileAndTime();" class="Wdate"/>
	  </td>
      <td class="colName">进厂行驶里程:</td>
      <td class="detailColVal">
      	 <input type="text" name="serv_servkilometer" id="serv_servkilometer" onblur="fillMileAndTime();"/>
	  </td>
...
<div id="sidebar-tab">
		<div id="tab-title">
			<div id="dingbao" class="selected">定保</div>
				...
				<table cellspacing="3" cellpadding="0">
				 <tr class="rowClass">
	   			 ...
	   			 <tr class="rowClass">
				      ...
				      <td class="detailColVal">
				          <input type="text" name="db_servhoursexp" id="db_servhoursexp" class="auto"/>
				          <input type="hidden" value="112001" name="db_servtype" id="db_servtype"/>
					  </td>
					  <td class="colName">工时折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="db_servhoursreb" id="db_servhoursreb" class="auto"/>
					  </td>
				      <td class="colName">工时会员折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="db_servhoursmembreb" id="db_servhoursmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      <td class="colName">零件费:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="db_servpartsexp" id="db_servpartsexp" class="auto"/>
					  </td>
					   <td class="colName">零件折扣:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="db_servpartsreb" id="db_servpartsreb" class="auto"/>
					  </td>
				      <td class="colName">零件会员折扣:</td>
				      <td class="detailColVal">
				      	<input type="text" name="db_servpartsmembreb" id="db_servpartsmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      ...
				      <td class="detailColVal">
					     <input type="text" name="db_servticketexp" id="db_servticketexp" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      <td class="colName">维修消费:</td>
				      <td class="detailColVal">
					     <input type="text" name="db_servrepairexp" id="db_servrepairexp" class="auto"/>
					  </td>
				    </tr>
			 </table>  
			</ul>
			<ul class="hide">
				...
				<tr><td colspan=6 style="color:#356aa0">钣喷费用</td></tr>
	   			 <tr class="rowClass">
				      <td class="colName">工时费:</td>
				      <td class="detailColVal">
				          <input type="text" name="bp_servhoursexp" id="bp_servhoursexp" class="auto"/>
				          <input type="hidden" value="112002" name="bp_servtype" id="bp_servtype"/>
					  </td>
					  <td class="colName">工时折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="bp_servhoursreb" id="bp_servhoursreb" class="auto"/>
					  </td>
				      <td class="colName">工时会员折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="bp_servhoursmembreb" id="bp_servhoursmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      <td class="colName">零件费:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="bp_servpartsexp" id="bp_servpartsexp" class="auto"/>
					  </td>
					   <td class="colName">零件折扣:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="bp_servpartsreb" id="bp_servpartsreb" class="auto"/>
					  </td>
				      <td class="colName">零件会员折扣:</td>
				      <td class="detailColVal">
				      	<input type="text" name="bp_servpartsmembreb" id="bp_servpartsmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">工时费合计:</td>
					  ...
					  <td class="colName">优惠券:</td>
				      <td class="detailColVal">
					     <input type="text" name="bp_servticketexp" id="bp_servticketexp" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      <td class="colName">维修消费:</td>
				      <td class="detailColVal">
					      <input type="text" name="bp_servrepairexp" id="bp_servrepairexp" class="auto"/>
					  </td>
				    </tr>
			 </table>  
			</ul>
				...
				<table cellspacing="3" cellpadding="0">
				 <tr><td colspan=6 style="color:#356aa0">保险事故费用</td></tr>
	   			 <tr class="rowClass">
				      <td class="colName">工时费:</td>
				      <td class="detailColVal">
				          <input type="text" name="sg_servhoursexp" id="sg_servhoursexp" class="auto"/>
				          <input type="hidden" name="sg_servtype" id="sg_servtype" value="112003"/>
					  </td>
					  <td class="colName">工时折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="sg_servhoursreb" id="sg_servhoursreb" class="auto"/>
					  </td>
				      <td class="colName">工时会员折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="sg_servhoursmembreb" id="sg_servhoursmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      <td class="colName">零件费:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="sg_servpartsexp" id="sg_servpartsexp" class="auto"/>
					  </td>
					   <td class="colName">零件折扣:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="sg_servpartsreb" id="sg_servpartsreb" class="auto"/>
					  </td>
				      <td class="colName">零件会员折扣:</td>
				      <td class="detailColVal">
				      	<input type="text" name="sg_servpartsmembreb" id="sg_servpartsmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">工时费合计:</td>
					  ...
					  <td class="colName">优惠券:</td>
				      <td class="detailColVal">
					     <input type="text" name="sg_servticketexp" id="sg_servticketexp" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
					  <td class="colName">保险消费:</td>
				      <td class="detailColVal">
				          <input type="text" name="sg_servinsureexp" id="sg_servinsureexp" class="auto"/>
					  </td>
				    </tr>
			   </table>  
			</ul>
				...
				<table cellspacing="3" cellpadding="0">
				 <tr><td colspan=6 style="color:#356aa0">首保费用</td></tr>
	   			 <tr class="rowClass">
				      <td class="colName">工时费:</td>
				      <td class="detailColVal">
				          <input type="text" name="sb_servhoursexp" id="sb_servhoursexp" class="auto"/>
				          <input type="hidden" name="sb_servtype" id="sb_servtype" value="112004"/>
					  </td>
					  <td class="colName">工时折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="sb_servhoursreb" id="sb_servhoursreb" class="auto"/>
					  </td>
				      <td class="colName">工时会员折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="sb_servhoursmembreb" id="sb_servhoursmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      <td class="colName">零件费:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="sb_servpartsexp" id="sb_servpartsexp" class="auto"/>
					  </td>
					   <td class="colName">零件折扣:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="sb_servpartsreb" id="sb_servpartsreb" class="auto"/>
					  </td>
				      <td class="colName">零件会员折扣:</td>
				      <td class="detailColVal">
				      	<input type="text" name="sb_servpartsmembreb" id="sb_servpartsmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">工时费合计:</td>
					  ...
					  <td class="colName">优惠券:</td>
				      <td class="detailColVal">
					     <input type="text" name="sb_servticketexp" id="sb_servticketexp" class="auto"/>
					  </td>
				    </tr>
				    <tr class="rowClass">
				      <td class="colName">维修消费:</td>
				      <td class="detailColVal">
					       <input type="text" name="sb_servrepairexp" id="sb_servrepairexp" class="auto"/>
					  </td>
				    </tr>
			   </table>  
			</ul>
				...
				<table cellspacing="3" cellpadding="0">
				 <tr><td colspan=6 style="color:#356aa0">一般维修费用</td></tr>
	   			 <tr>
				      <td class="colName">工时费:</td>
				      <td class="detailColVal">
				          <input type="text" name="yb_servhoursexp" id="yb_servhoursexp" class="auto"/>
				          <input type="hidden" name="yb_servtype" id="yb_servtype" value="112005"/>
					  </td>
					  <td class="colName">工时折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="yb_servhoursreb" id="yb_servhoursreb" class="auto"/>
					  </td>
				      <td class="colName">工时会员折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="yb_servhoursmembreb" id="yb_servhoursmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">零件费:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="yb_servpartsexp" id="yb_servpartsexp" class="auto"/>
					  </td>
					   <td class="colName">零件折扣:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="yb_servpartsreb" id="yb_servpartsreb" class="auto"/>
					  </td>
				      <td class="colName">零件会员折扣:</td>
				      <td class="detailColVal">
				      	<input type="text" name="yb_servpartsmembreb" id="yb_servpartsmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">工时费合计:</td>
					  ...
					  <td class="colName">优惠券:</td>
				      <td class="detailColVal">
					     <input type="text" name="yb_servticketexp" id="yb_servticketexp" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				    <td class="colName">维修消费:</td>
				      <td class="detailColVal">
					       <input type="text" name="yb_servrepairexp" id="yb_servrepairexp" class="auto"/>
					  </td>
				    </tr>
			   </table>  
			</ul>
				...
				<table cellspacing="3" cellpadding="0">
				 <tr><td colspan=6 style="color:#356aa0">保修费用</td></tr>
	   			 <tr>
				      <td class="colName">工时费:</td>
				      <td class="detailColVal">
				          <input type="text" name="bx_servhoursexp" id="bx_servhoursexp" class="auto"/>
				          <input type="hidden" name="bx_servtype" id="bx_servtype" value="112009"/>
					  </td>
					  <td class="colName">工时折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="bx_servhoursreb" id="bx_servhoursreb" class="auto"/>
					  </td>
				      <td class="colName">工时会员折扣:</td>
				      <td class="detailColVal">
				          <input type="text" name="bx_servhoursmembreb" id="bx_servhoursmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">零件费:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="bx_servpartsexp" id="bx_servpartsexp" class="auto"/>
					  </td>
					   <td class="colName">零件折扣:</td>
				      <td class="detailColVal">
				      	 <input type="text" name="bx_servpartsreb" id="bx_servpartsreb" class="auto"/>
					  </td>
				      <td class="colName">零件会员折扣:</td>
				      <td class="detailColVal">
				      	<input type="text" name="bx_servpartsmembreb" id="bx_servpartsmembreb" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">工时费合计:</td>
					  ...
					  <td class="colName">优惠券:</td>
				      <td class="detailColVal">
					     <input type="text" name="bx_servticketexp" id="bx_servticketexp" class="auto"/>
					  </td>
				    </tr>
				    <tr>
				      <td class="colName">维修消费:</td>
				      <td class="detailColVal">
					     <input type="text" name="bx_servrepairexp" id="bx_servrepairexp" class="auto"/>
					  </td>
				    </tr>
			   </table>  
			</ul>
...
<table cellspacing="3" cellpadding="0">
	 <tr class="rowClass">
	     <td class="colName">工时总额:</td>
	      <td class="detailColVal">
	        <input type="text" name="serv_servhoursexp" id="serv_servhoursexp" class="auto gs"/>
	      </td>
	      <td class="colName">零件总额:</td>
	      <td class="detailColVal">
	         <input type="text" name="serv_servpartsexp" id="serv_servpartsexp" class="auto"/>
		  </td>
		  <td class="colName">优惠劵总额:</td>
	      <td class="detailColVal">
	        <input type="text" name="serv_servticketexp" id="serv_servticketexp" class="auto"/>
	      </td>
	  </tr>
	  <tr class="rowClass">
	  	  <td class="colName">现金消费:</td>
	      <td class="detailColVal">
	         <input type="text" name="serv_servcashexp" id="serv_servcashexp" class="auto"/>
		  </td>
	      <td class="colName">转账:</td>
	      <td class="detailColVal">
	      	 <input type="text" name="serv_servtransfer" id="serv_servtransfer" class="auto"/>
		  </td>
    ...
    <tr class="rowClass">
      ...
      <td class="detailColVal">
      	 <input type="text" name="serv_servamountexp" id="serv_servamountexp" class="auto"/>
	  </td>
      <td class="colName">维修项目:</td>
      <td class="detailColVal" colspan=3>
      	<input style="width:80%;" type="text" name="serv_servitems" id="serv_servitems" />
	  </td>
    </tr>
     <tr class="rowClass">
    ...
    <tr class="rowClass">
      ...
      <td class="detailColVal">
      	 <input type="text" name="serv_servouttime" id="serv_servouttime" onfocus="dayCalender(this)" class="Wdate" style="background-color: yellow;"/>
	  </td>
      ...
      <td class="detailColVal">
        <input type="text" name="serv_resveorederid" id="serv_resveorederid"/>
	  </td>
    </tr>
    <tr class="rowClass">
  	...
  	<table cellspacing="3" cellpadding="0">
  		<tr class="rowClass">
  			<c:forEach items="${dict.crm_jyType}" var="var">				
	  			...
	  			<td class="detailColVal">
	  				大<input type="text" value="1" disabled name="jybignum" style="width:30px;text-align:center;background-color:#ccc;"/>桶&nbsp;
	  				小<input type="text" value="1" disabled name="jysmallnum" style="width:30px;text-align:center;background-color:#ccc;"/>桶
	  			</td>
  			</c:forEach>
  		</tr>
   		<tr class="rowClass">
	   		<td colspan=8>
				<div style="margin-top:3px;text-align:right;margin-right:20px;">
					节约机油：<select id="jystate" name="jystate"><option value=""></option><option value="0">带走</option><option value="1">外销</option></select>
					<input type="button" id="addjyBtn" value="添加机油信息" onclick="javascript:addJY();" style="background-color:#ccc;cursor:pointer;"/>
				</div>
			</td>
   		</tr>
  	</table>
  	...
  	<table id="maintainTb">
  		...
  		<tr class="rowClass">
   		...
   		<tr class="rowClass">
			<td class="colName"></td>
  			<td class="detailColVal">
				<input type="button" value="计算生成" onclick="javascript:calculate();" style="background-color:red;width:150px;cursor:pointer;">
			</td>
   		...
   		<tr class="rowClass">
	   		<td colspan=6>
				<div style="margin-top:3px;text-align:right;margin-right:20px;">
					<input type="button" value="更新下次保养时间" id="updateMileBtn" onclick="javascript:updateMile();" style="background-color:red;cursor:pointer;"/>
				</div>
			</td>
   		</tr>
  	</table>
  ...
  <table style="width:900px;margin:auto;">
	  <tr class="rowClass">
	 	<td style="text-align:center;width:150px;">
  			<input type="button" id="subBtn" style="background-color:#ccc;width:140px;cursor:pointer;" onclick="javascript:doSubmit();" value="确定"/>
	  	</td>
	  	<td style="text-align:center;width:150px;">
	  		<input type="reset"  style="background-color:#ccc;width:140px;cursor:pointer;" value="重置"/>
	  	</td>
	  	<td style="text-align:center;width:150px;">
	  		 <input type="button" id="returnBtn" style="background-color:#ccc;width:140px;cursor:pointer;" onclick="window.location.href='${pageContext.request.contextPath}/crm::/serviceModule/action/QueryServiceList.action?startIndex=0&endIndex=9'"value="返回"/>
	  	</td>
	  	<td style="text-align:center;width:150px;">
	  		<input type="button" style="background-color:#ccc;width:140px;cursor:pointer;" onclick="javascript:addPartsWin();" value="精品"/>
	  	</td>
	  	<td style="text-align:center;width:150px;">
