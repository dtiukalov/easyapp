...
public class QACommand  extends AbstractAIFCommand{
	public PrintLog pirintlog = null ;	//日志输出对象
	private InterfaceAIFComponent pasteTargets[];  //当前选中位置
	
	public QACommand(AbstractAIFApplication app, Frame frame){
		...
		//调用Dialog
		AbstractAIFDialog abstractAIFDialog = new QADialog(this, frame, app,pasteTargets,pirintlog);
