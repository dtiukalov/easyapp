		...
		<form id="editForm"
			...
			<table class="table-form">
				<tr>
					...
					<td><input id="number" name="number" type="text" value="2200049305"></input></td>
				...
				<tr>
					...
					<td><input id="title" name="title" type="text" value="销售"></input></td>
					<td><div id="titleTip"></div></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input id="title" name="title" type="text" value="00909922"></input></td>
					<td><div id="titleTip"></div></td>
				</tr>
				<tr>
