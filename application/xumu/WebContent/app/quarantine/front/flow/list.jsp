...
<form id="addForm" name="addForm"
			...
			method="post">
<label style="font-size:35px;margin-right:560px;">检疫信息列表：</label>
<table cellpadding="0px" cellspacing="1px" bgcolor="#000000" width="800px">
<tr bgcolor="#ffffff" height="70px">
<td style="font-size:25px;font-weight:bold;width:170px">证书类型</td>
<td style="font-size:25px;font-weight:bold;width:90px">货主</td>
<td style="font-size:25px;font-weight:bold;width:120px">联系电话</td>
<td style="font-size:25px;font-weight:bold;width:120px">动物种类</td>
<td style="font-size:25px;font-weight:bold;width:100px">数量</td>
<td style="font-size:25px;font-weight:bold;width:120px">签发日期</td>
<td style="font-size:25px;font-weight:bold;width:150px">操作</td>
</tr>
...
<td style="font-size:20px;"><a href="<%=request.getContextPath() %>/app/quarantine/front/flow/show.jsp">查看</a>&nbsp;<a href="<%=request.getContextPath() %>/app/quarantine/front/flow/result.jsp">监管处理</a></td>
</tr>
<tr bgcolor="#ffffff" height="50px">
<td style="font-size:20px;">动物A证</td>
<td style="font-size:20px;">王乐乐</td>
