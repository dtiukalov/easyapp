	...
	<script type="text/javascript">
		$(function() {
			$('#queryTable').datagrid({
				...
				url : '<%=request.getContextPath()%>/app/recall/admin/json/deadDemo.json',
				idField : 'id',//唯一标识列
				sortName : 'id',
				sortOrder : 'desc',
				remoteSort : true,
				...
				toolbar : [ {
					...
					iconCls : 'icon-add',
					handler : function() {
						window.location.href='<%=request.getContextPath() %>/app/recall/admin/dead/add.jsp';
		...
		function editVO(id){
			window.location.href='<%=request.getContextPath() %>/app/recall/admin/dead/edit.jsp';
			return false;
		}
	</script>
</head>
