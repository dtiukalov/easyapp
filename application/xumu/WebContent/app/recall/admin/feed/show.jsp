	...
	<script type="text/javascript">
		$(function() {
			$('#queryTable').datagrid({
				...
				url : '<%=request.getContextPath()%>/app/recall/admin/json/feedDemo.json',
				idField : 'id',//唯一标识列
				sortName : 'id',
				sortOrder : 'desc',
				remoteSort : true,
				...
				toolbar : [ {
					...
					iconCls : 'icon-add',
					handler : function() {
						window.location.href='<%=request.getContextPath()%>/app/recall/admin/feed/add.jsp';
		...
		function editVO(id){
			window.location.href='<%=request.getContextPath()%>/app/recall/admin/feed/edit.jsp';
			return false;
		}
	</script>
</head>
