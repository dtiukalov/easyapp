...
<%
	Map pigs = (Map)session.getAttribute(FarmerPig.SESSION_ADD);
	
	if (pigs == null) {
		pigs = new HashMap();
		pigs.put("仔猪", new FarmerPig(null, null, "新增", "仔猪", "", "", "", null, null));
		pigs.put("育肥猪", new FarmerPig(null, null, "新增", "育肥猪", "", "", "", null, null));
		pigs.put("能繁母猪", new FarmerPig(null, null, "新增", "能繁母猪", "", "", "", null, null));
		pigs.put("后备母猪", new FarmerPig(null, null, "新增", "后备母猪", "", "", "", null, null));
		session.setAttribute(FarmerPig.SESSION_ADD, pigs);
	}
...
<td style="font-size:25px;">新增类别</td>
<td colspan="2" style="font-size:25px;">数量（头）</td>
<td colspan="2" style="font-size:25px;">单价（元/斤）</td>
<td colspan="2" style="font-size:25px;">本次购买共花费（元）<br/>注：自繁自育不用填</td></tr>
...
<td width="150px;"><input id="num3" name="num3" type="text" value="<%=p3.getNum()%>"/></td><td width="50px;" style="font-size:40px;">头</td>
...
<td width="150px;"><input id="num4" name="num4" type="text" value="<%=p4.getNum()%>"/></td><td width="50px;" style="font-size:40px;">头</td>
