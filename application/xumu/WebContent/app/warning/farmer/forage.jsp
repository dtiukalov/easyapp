...
<form id="addForm" name="addForm"
			action="<%=request.getContextPath()%>/app/warning/farmer/forage.do"
			method="post">
<table cellpadding="0px" cellspacing="1px" bgcolor="#000000" width="800px" style="font-weight:bold">
<tr bgcolor="#ffffff"><td style="font-size:35px;line-height:80px;" colspan=7>饲料购进</td></tr>
<tr bgcolor="#ffffff" height="100px">
<td style="font-size:25px;width:250px;">饲料类别</td>
...
<td width="150px;"><input id="num1" name="num1" type="text" value="<%=p1.getNum()%>"/></td><td width="50px;" style="font-size:30px;">斤</td>
...
<td width="150px;"><input id="num2" name="num2" type="text" value="<%=p2.getNum()%>"/></td><td width="50px;" style="font-size:30px;">斤</td>
...
<td width="150px;"><input id="num3" name="num3" type="text" value="<%=p3.getNum()%>"/></td><td width="50px;" style="font-size:30px;">斤</td>
...
<td width="150px;"><input id="num4" name="num4" type="text" value="<%=p4.getNum()%>"/></td><td width="50px;" style="font-size:30px;">斤</td>
...
<td width="150px;"><input id="num5" name="num5" type="text" value="<%=p5.getNum()%>"/></td><td width="50px;" style="font-size:30px;">斤</td>
<td width="120px;"><input id="price5" name="price5" type="text" style="width:120px;" value="<%=p5.getPrice()%>"/></td><td width="50px;" style="font-size:30px;">元</td>
<td width="200px;"><input id="total5" name="total5" type="text" style="width:200px;" value="<%=p5.getTotal()%>"/></td><td width="50px;" style="font-size:30px;">元</td>
</tr>
</table>
<table width="800px">
<tr>
