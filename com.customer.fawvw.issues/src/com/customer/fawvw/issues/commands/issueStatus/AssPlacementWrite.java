...
public class AssPlacementWrite {
	...
	static void importDataPage(HSSFWorkbook workbook,
		...
		if (values.get("assPlacement") != null) { //$NON-NLS-1$
			HashMap<String, Object> AssIssues = (HashMap<String, Object>)values.get("assPlacement"); //$NON-NLS-1$
			...
			int sum = ((Map<String, Integer>) AssIssues.get("front")).get("red") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("front")).get("yellow") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("front")).get("green") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("chassis")).get("red") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("chassis")).get("yellow") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("chassis")).get("green") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("electronik")).get("red") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("electronik")).get("yellow") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("electronik")).get("green") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("driver")).get("red") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("driver")).get("yellow") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("driver")).get("green") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("door")).get("red") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("door")).get("yellow") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("door")).get("green") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("inner")).get("red") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("inner")).get("yellow") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("inner")).get("green") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("behind")).get("red") +  //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("behind")).get("yellow") + //$NON-NLS-1$ //$NON-NLS-2$
			((Map<String, Integer>) AssIssues.get("behind")).get("green"); //$NON-NLS-1$ //$NON-NLS-2$
