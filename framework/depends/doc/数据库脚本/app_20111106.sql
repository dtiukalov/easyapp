...
insert  into `wf_node_condition`(`id`,`nodeId`,`model`,`modelName`,`type`,`typeName`,`value`,`valueName`,`sign`) values (3,3,'node.condition.creater','创建者','node.condition.creater.self','创建者','','','否'),(5,3,'node.condition.auth','权限','node.condition.auth.user','用户','123','123','否'),(6,3,'node.condition.auth','权限','node.condition.auth.role','角色','superAdmin','superAdmin','否'),(8,7,'node.condition.workflow','工作流','node.condition.creater','创建者','node.condition.creater.self','本人','否'),(9,8,'node.condition.workflow','工作流','node.condition.creater','创建者','node.condition.creater.self','本人','否'),(10,9,'node.condition.workflow','工作流','node.condition.creater','创建者','node.condition.creater.self','本人','否'),(12,4,'node.condition.auth','权限','node.condition.auth.department','部门','rrr','rrr','否'),(28,6,'node.condition.workflow','工作流','node.condition.creater','创建者','node.condition.creater.self','本人','否');
...
insert  into `wf_node_item_state`(`id`,`flowId`,`nodeId`,`itemName`,`state`) values (43,10,3,'name','必填'),(44,10,4,'name','只读'),(45,10,5,'name','只读'),(46,10,3,'age','选填'),(47,10,4,'age','只读'),(48,10,5,'age','只读'),(49,10,3,'gender','只读'),(50,10,4,'gender','只读'),(51,10,5,'gender','只读'),(132,11,6,'name','只读'),(133,11,7,'name','只读'),(134,11,8,'name','只读'),(135,11,9,'name','只读'),(136,11,6,'start','必填'),(137,11,7,'start','只读'),(138,11,8,'start','只读'),(139,11,9,'start','只读'),(140,11,6,'end','必填'),(141,11,7,'end','只读'),(142,11,8,'end','只读'),(143,11,9,'end','只读'),(144,11,6,'days','必填'),(145,11,7,'days','只读'),(146,11,8,'days','只读'),(147,11,9,'days','只读'),(148,11,6,'departmentAdvise','隐藏'),(149,11,7,'departmentAdvise','必填'),(150,11,8,'departmentAdvise','只读'),(151,11,9,'departmentAdvise','只读'),(152,11,6,'hrAdvise','隐藏'),(153,11,7,'hrAdvise','隐藏'),(154,11,8,'hrAdvise','必填'),(155,11,9,'hrAdvise','只读');
