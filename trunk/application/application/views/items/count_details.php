...
<tr bgcolor="#FF0033" align="center" style="font-weight:bold"><td colspan="4">库存数据跟踪</td></tr>
<tr align="center" style="font-weight:bold"><td width="15%">日期</td><td width="25%">员工</td><td width="15%">输入/输出数量</td><td width="45%">备注</td></tr>
<?php
