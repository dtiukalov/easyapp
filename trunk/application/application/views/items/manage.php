...
<div id="title_bar">
	...
	<div id="new_button">
		...
		"<div class='big_button' style='float: left;'><span>Excel导入</span></div>",
		array('class'=>'thickbox none','title'=>'从Excel中导入商品'));
		?>
	</div>
</div>

<div id="titleTextImg" style="background-color:#EEEEEE;height:20px;position:relative;">
	<div style="float:left;vertical-align:text-top;">查询选项 :</div>
