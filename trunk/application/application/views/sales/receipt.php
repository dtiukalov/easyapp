...
<!--	<th style="width:25%;"><?php echo $this->lang->line('sales_item_number'); ?></th> -->
	...
	<th style="width:12%;"><?php echo $this->lang->line('common_price'); ?></th>
	<th style="width:12%;text-align:center;"><?php echo $this->lang->line('sales_quantity'); ?></th>
<!--	<th style="width:16%;text-align:center;"><?php echo $this->lang->line('sales_discount'); ?></th> -->
	<th style="width:12%;text-align:right;"><?php echo $this->lang->line('sales_total'); ?></th>
	</tr>
	<?php
...
<!--		<td><?php echo $item['item_number']; ?></td>  -->
		<td colspan="4"><span class='long_name' ><?php echo $item['name']; ?></span>
...
<!--		<td style='text-align:center;'><?php echo $item['discount']; ?></td>  -->
	    ...
	    <tr>
	    <td colspan="1" align="center"><?php echo $item['description']; ?></td>
	    <td colspan="1" align="center"><?php echo $comment; ?></td>
		<td colspan="1" ><?php echo $item['serialnumber']; ?></td>
