...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('suppliers_company_brand').':', 'company_brand', array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'company_brand',
		'id'=>'company_brand',
		'value'=>$person_info->brand)
	);?>
	</div>
</div>
...
$(document).ready(function()
{
	$('#supplier_form').validate({
		...
		messages: 
		{
			company_brand:"<?php echo $this->lang->line('suppliers_company_brand_required'); ?>",
