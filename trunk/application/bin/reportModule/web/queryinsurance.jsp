...
<script type="text/javascript">
		function tmac(){
			$('#exportForm')[0].action = "<%=request.getContextPath()%>/crm::/reportModule/action/QueryNewInsurance.action";
			$('#exportForm')[0].submit();
		}
</script> 
<title>售后前台--投保台次</title>
</head>
<body>
<div id="man_zone">
	<form id="crmform" class="queryFrom" action="${pageContext.request.contextPath}/crm::/reportModule/action/QueryInsurance.action">
		<fieldset>
		  <legend>售后前台--投保台次</legend>
    ...
    <table class="optDiv"  style=''>
		<tr>
			...
			<td><div id="paginate"><a href="javascript:tmac();">导出</a></div></td>
		</tr>
	</table>
           	...
           	<tr>
				...
				<%
					...
					for(int i=0; i<result.size(); i++){
						...
						if(sumid.get("insudaycount")!=null){
							j+= Integer.parseInt(sumid.get("insudaycount").toString());
						}
						if(sumid.get("insumoncount")!=null){
							s+= Integer.parseInt(sumid.get("insumoncount").toString());
						}
					}
					out.print(j);
				%>
