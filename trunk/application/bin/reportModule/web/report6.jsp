...
<script type="text/javascript">
		function QueryPart(){
			$('#exportForm')[0].action = "<%=request.getContextPath()%>/crm/reportModule/web/report6Excel.jsp";
			$('#exportForm')[0].submit();
		}
...
<div id="man_zone">
              ...
              <table cellspacing="0" cellpadding="0">
                   <tr>                    
                     ...
                     <td class="detailColVal" colspan="10">
                     	<input type="hidden" name="typez" id="typez" value="yh">
	...
	if (obj != null){
		...
		session.removeAttribute("report6");
		session.setAttribute("report6",report1);
	%>
