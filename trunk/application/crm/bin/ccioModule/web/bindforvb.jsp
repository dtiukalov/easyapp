...
<body>
<div id="man_zone">
<form id="crmform" class="contentForm" method="post" action="${pageContext.request.contextPath}/crm::/ccioModule/action/SetBind.action">
<input type="hidden" name="startIndex" value="0"/>
<input type="hidden" name="endIndex" value="9"/>
<input type="hidden" name="b_card" id="b_card" value=""/>
<fieldset>
<legend>绑定卡</legend>
<table cellspacing="10" cellpadding="0">
   <tr>
      ...
      <td class="detailColVal">
          <input type="text" name="t_b_card" id="t_b_card" style="width:200px;"/>
	  </td>
  </tr>
  <tr>
      <td class="colName">VIN:</td>
      <td class="detailColVal">
         <input type="text" name="b_vin" id="b_vin" value="" autocomplete="off" style="width:200px;"/>
	  </td>
   <tr>
  </table>
