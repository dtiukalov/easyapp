...
<%
    String filename= request.getAttribute("dutyintime") + "售后总值报表";
...
int tip=2;
	if (oneresult != null){
		if (!oneresult.isEmpty()) {
			...
			HSSFRow rowi = sheet.createRow(tip++);
			cell = rowi.createCell(0);
			cell.setCellValue("1-3天   共有"+i+"台车");
			cell.setCellStyle(cs);
		}
	}
if (tworesult != null){
		if (!tworesult.isEmpty()) {
			...
			HSSFRow rowi = sheet.createRow(tip++);
			cell = rowi.createCell(0);
			cell.setCellValue("4-7天   共有"+i+"台车");
			cell.setCellStyle(cs);
		}
	}
if (threeresult != null){
		if (!threeresult.isEmpty()) {
			...
			HSSFRow rowi = sheet.createRow(tip++);
			cell = rowi.createCell(0);
			cell.setCellValue("7天以上或没定提车时间的   共有"+i+"台车");
			cell.setCellStyle(cs);
		}
	}
