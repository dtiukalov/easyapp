...
<script type="text/javascript">
		function queryoils(){
			$('#exportForm')[0].action = "<%=request.getContextPath()%>/crm/reportModule/web/report3Excel.jsp";
			$('#exportForm')[0].submit();
		}
</script> 
...
<div id="man_zone">
              ...
              <table cellspacing="0" cellpadding="0">
                   <tr>                    
                     ...
                     <td class="detailColVal" colspan="10">
                     	<input type="hidden" name="typez" id="typez" value="jy">
	...
	if (obj != null){
		...
		session.removeAttribute("report3");
		session.setAttribute("report3",report1);
	%>
...
<div style="display:none;">
	<form id="exportForm" name="exportForm" method="post">
		...
		<input type="hidden" name="jycount" id="jycount" value="${jycount}">
