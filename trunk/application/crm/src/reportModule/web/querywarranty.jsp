...
<body>
<div id="man_zone">
	<form id="crmform" class="queryFrom" action="${pageContext.request.contextPath}/crm::/reportModule/action/QueryWarranty.action">
		<fieldset>
				...
				<%
					...
					for(int i=0; i<result.size(); i++){
						...
						if(sumid.get("sumdaycare")!=null){
							j+= Integer.parseInt(sumid.get("sumdaycare").toString());
						}
						if(sumid.get("summoncare")!=null){
							s+= Integer.parseInt(sumid.get("summoncare").toString());
						}
					}
					out.print(j);
				%>
