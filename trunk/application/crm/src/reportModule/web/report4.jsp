...
<script type="text/javascript">
		function tmac(){
			$('#exportForm')[0].action = "<%=request.getContextPath()%>/crm/reportModule/web/report4Excel.jsp";
			$('#exportForm')[0].submit();
		}
</script> 
...
<div id="man_zone">
              ...
              <table cellspacing="0" cellpadding="0">
                   <tr>                    
                     ...
                     <td class="detailColVal" colspan="10">
                     	<input type="hidden" name="typez" id="typez" value="tb">
	...
	if (obj != null){
		...
		session.removeAttribute("report4");
		session.setAttribute("report4",report1);
	%>
