...
<%
	...
	String fv9ProductstandStatus = "绿";// (String) form.get("fv9ProductstandStatus");
	...
	// (String) form.get("fv9ProdStatusComC");
	...
	// (String) form.get("fv9FunktionComC");
	...
	// (String) form.get("fv9ProduktionComC");
	...
	// (String) form.get("fv9BeschaffComC");
	...
	// (String) form.get("fv9VertriebComC");
	...
	// (String) form.get("fv9FinanzenComC");
	...
	// (String) form.get("fv9GewichtComC");
