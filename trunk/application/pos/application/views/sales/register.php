...
<?php echo form_open("sales/change_mode",array('id'=>'mode_form')); ?>
	<span><?php echo '&nbsp'.$this->lang->line('sales_mode') ?></span>
<?php echo form_dropdown('mode',$modes,$mode,'onchange="$(\'#mode_form\').submit();"'); ?>
<div id="show_suspended_sales_button">
	<?php echo anchor("sales/suspended/width:425",
	"<div class='small_button'><span style='font-size:12px;'>".$this->lang->line('sales_suspended_sales')."</span></div>",
...
<th style="width:17%;"><?php echo $this->lang->line('sales_item_number'); ?></th>
<th style="width:17%;"><?php echo $this->lang->line('sales_item_name'); ?></th>
...
else
{
	...
	?>
		...
		<td style="align:center;"><?php echo $item['name']; ?><br /> [<?php echo $cur_item_info->quantity; ?>个在仓库]</td>
...
<div id="overall_sale">
    ...
    <table width="100%"><tr>
    <td style="width:55%; "><div class="float_left"><?php echo '支付总计:' ?></div></td>
	...
	<tr>
	<td style="width:55%; "><div class="float_left" ><?php echo '待(找零)支付:' ?></div></td>
	...
	<div id="Payment_Types" >
		...
		?>
			...
			<th style="width:50%;"><?php echo 'Type'; ?></th>
