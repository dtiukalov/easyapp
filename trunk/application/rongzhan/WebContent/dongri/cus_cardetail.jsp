...
%>
<jsp:include flush="true" page="../include/tianlai.jsp"/>
<%
}else if("car.dongfengnissan.xuanyi".equals(model)){
%>
<jsp:include flush="true" page="../include/xuanyi.jsp"/>
<%
}else if("car.dongfengnissan.qijun".equals(model)){
%>
<jsp:include flush="true" page="../include/qijun.jsp"/>
<%
}else if("car.dongfengnissan.xiaoke".equals(model)){
%>
<jsp:include flush="true" page="../include/xiaoke.jsp"/>
<%
...
%>
<jsp:include flush="true" page="../include/qida.jsp"/>
<%
}else if("car.dongfengnissan.liwei".equals(model)){
%>
<jsp:include flush="true" page="../include/liwei.jsp"/>
<%
}else if("car.dongfengnissan.yangguang".equals(model)){
%>
<jsp:include flush="true" page="../include/yangguang.jsp"/>
<%
}else if("car.dongfengnissan.machi".equals(model)){
%>
<jsp:include flush="true" page="../include/machi.jsp"/>
<%
}else{
%>
无
