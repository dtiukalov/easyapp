...
<div id="content">
	...
	<div class="con2">
    	<div class="cxzs">
        	<div class="cxzst">
            	<h1>车型展示</h1>
                <span><a href="cus_cars.jsp?cid=rongsheng.sall&aid=rongsheng.sall.new">更多</a></span>
            </div>
            <div class="cxzsbg">
            <%
        	//List cars = NewCar.getListByCid(WebUtils.getRootCid(request));
            String[] modelz={"car.audi.a4l","car.audi.a6l","car.audi.q5"};
    ...
    <%
        ...
        <div class="ycxhd">
            ...
            <div class="tupian">
       			<a href="cus_bookcar.jsp?cid=rongsheng.book&aid=rongsheng.book.drive"><img src="images/yysj.jpg" /></a>
        		<a href="cus_bookcar.jsp?cid=rongsheng.book&aid=rongsheng.book.maintain"><img src="images/byyy.jpg" /></a>
        		<a href="cus_bookcar.jsp?cid=rongsheng.book&aid=rongsheng.book.repair"><img src="images/wxyy.jpg" /></a>
            </div>
        </div><!--右侧促销活动等-->
    </div><!--第二行-->
</div><!--内容-->
