...
<div id="content">  
    ...
    <div class="right">
        ...
        <div class="ynr">
        	<div class="neirong"><table cellspacing="5" cellpadding="5" width="95%"  height="337px" align="center" border="0">
        	    <tbody>
        	    <%
				...
				%>
				<tr>
        	        <td><div align="left"><img src="images/iecool_arrow_013.gif" width="9" height="9" />　<a href="detail.jsp?cid=<%=__cid%>&aid=<%=__aid%>&did=<%=did%>"><%=title%> </a><%=typeShow%></div></td>
        	        <td>[<%=datetime%>]</td>
      	        </tr>
				<%
					}
