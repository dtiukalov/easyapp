...
<div id="content">
	...
	<div class="con2">
    	<div class="cxzs">
        	<div class="cxzst">
            	<h1>车型展示</h1>
                <span><a href="cus_cars.jsp?cid=xinyu.sall&aid=xinyu.sall.new">更多</a></span>
            </div>
            <div class="cxzsbg">
            <%
        	//List cars = NewCar.getListByCid(WebUtils.getRootCid(request));
            String[] modelz={"car.yiqivw.suteng","car.yiqivw.jieda","car.yiqivw.maiteng","car.yiqivw.baolai","car.yiqivw.gaoerfu","car.yiqivw.gti","car.yiqivw.cc"};
    ...
    <%
        ...
        <div class="ycxhd">
            ...
            <div class="tupian">
       			<a href="cus_bookcar.jsp?cid=xinyu.book&aid=xinyu.book.drive"><img src="images/yysj.jpg" /></a>
        		<a href="cus_bookcar.jsp?cid=xinyu.book&aid=xinyu.book.maintain"><img src="images/byyy.jpg" /></a>
        		<a href="cus_bookcar.jsp?cid=xinyu.book&aid=xinyu.book.repair"><img src="images/wxyy.jpg" /></a>
            </div>
        </div><!--右侧促销活动等-->
    </div><!--第二行-->
</div><!--内容-->
