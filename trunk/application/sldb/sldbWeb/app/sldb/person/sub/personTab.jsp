...
<body>
		...
		<div id="tab" class="easyui-accordion" fit="true" style="width:300px;height:438px;">
			<div title="家庭信息" selected="true" style="overflow:auto;padding:10px;">
				<div class="easyui-tabs"  plain="true" fit="true" style="height:388px;width:500px;">
				<div title="${person.name}-户主">
				<table class="table-form" border="1"; style="width:100%; border-collapse:collapse;">
					<tr>
