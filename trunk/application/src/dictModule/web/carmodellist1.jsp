...
<script type="text/javascript">
		$(function() { 
			$("#paginate").saturnTablePaginate({
				...
				action:'${pageContext.request.contextPath}/crm::/dictModule/action/QueryCarList1.action',
				form:'crmform',
				percount:10
			});
		});
		...
		function modify(type,code,hidden_flag){
			$('#hiddenForm')[0].action = "${pageContext.request.contextPath}/crm::/dictModule/action/HiddenDict.action?dict_type="+type+"&dict_code="+code+"&dict_hidden_flag="+hidden_flag+"&var_pinyin=0";
			$('#hiddenForm')[0].submit();
		}
...
<body>
<div id="man_zone">
		<form id="crmform" class="queryFrom" method="post" action="${pageContext.request.contextPath}/crm::/dictModule/action/QueryCarList1.action">
