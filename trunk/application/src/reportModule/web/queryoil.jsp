...
<script type="text/javascript">
		function queryoils(){
			$('#exportForm')[0].action = "<%=request.getContextPath()%>/crm::/reportModule/action/QueryNewOil.action";
			$('#exportForm')[0].submit();
		}
</script> 
<title>售后前台--节余机油</title>
</head>
<body>
<div id="man_zone">
	<form id="crmform" class="queryFrom" action="${pageContext.request.contextPath}/crm::/reportModule/action/QueryOil.action">
		<fieldset>
		  <legend>售后前台--节余机油</legend>
    ...
    <table class="optDiv"  style=''>
		<tr>
			...
			<td><div id="paginate"><a href="javascript:queryoils();">导出</a></div></td>
		</tr>
	</table>
           	...
           	<tr>
				...
				<%
					...
					for(int i=0; i<result.size(); i++){
						...
						if(sumid.get("oildaycount")!=null){
							j+= Integer.parseInt(sumid.get("oildaycount").toString());
						}
						if(sumid.get("oilmoncount")!=null){
							s+= Integer.parseInt(sumid.get("oilmoncount").toString());
						}
					}
					out.print(j);
				%>
