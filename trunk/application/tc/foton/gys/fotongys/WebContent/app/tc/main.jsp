...
<body class="easyui-layout">
	...
	<div region="north" split="false"
		...
		<div class="top_img">
	    	...
	    	<div class="user-info"><%=International.get(request, "username") %>:<%=user.get_user_name()%>(<%=user.get_userid()%>)[<a href="<%=request.getContextPath()%>/gyshelp.pdf"><%=International.get(request, "help")%></a>][<a href="<%=request.getContextPath()%>/app/tc/logout.do"><%=International.get(request, "logout") %></a>] </div>
		</div> 
	</div>
