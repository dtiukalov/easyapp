...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		$(function() {
			$('#queryTable').datagrid({
				...
				toolbar : [ {
					...
					iconCls : 'icon-add',
					handler : function() {
						window.location.href='<%=request.getContextPath()%>/app/quarantine/admin/animal/addA.jsp';
					...
					iconCls : 'icon-add',
					handler : function() {
						window.location.href='<%=request.getContextPath()%>/app/quarantine/admin/animal/addB.jsp';
						return false;//解决IE6的不跳转的bug
					}
				},{
					id : 'btndelete',
					...
					handler : function() {
						...
						$.messager.confirm('确认删除项', '确认删除该选项', function(result){
							if (result){
								window.location.href='<%=request.getContextPath()%>/app/quarantine/admin/animalA/show.jsp';
							}
						});
						return false;
					}
		...
		function editVO(id){
			window.location.href='<%=request.getContextPath()%>/app/quarantine/admin/animalA/edit.jsp';
			return false;
		}
		
		function viewVO(id){
			window.location.href='<%=request.getContextPath()%>/app/quarantine/admin/animal/view.jsp';
			return false;
		}
	</script>
</head>
