	...
	<div id="panel" class="easyui-panel" title="添加"
		...
		<form id="addForm"
			...
			<table class="table-form">
				...
				<tr>
					<td style="text-align:right">个体编号:</td>
				...
				<tr>
					<td style="text-align:right">母号:</td>
					<td><input id="number" name="number" type="text"></input></td>
					<td><div id="numberTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right">父号:</td>
					<td><input id="title" name="title" type="text"></input></td>
					<td><div id="titleTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right">种畜场名称:</td>
					<td><input id="number" name="number" type="text"></input></td>
					<td><div id="numberTip"></div></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="text-align:right">种畜禽生产经营许可证编号:</td>
					<td><input id="number" name="number" type="text"></input></td>
					<td><div id="numberTip"></div></td>
				</tr>
				<tr>
