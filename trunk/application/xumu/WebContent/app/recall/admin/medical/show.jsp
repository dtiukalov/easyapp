	...
	<script type="text/javascript">
		$(function() {
			$('#queryTable').datagrid({
				...
				url : '<%=request.getContextPath()%>/app/recall/admin/json/medicalDemo.json',
				idField : 'id',//唯一标识列
				sortName : 'id',
				sortOrder : 'desc',
				remoteSort : true,
				...
				toolbar : [ {
					...
					iconCls : 'icon-add',
					handler : function() {
						window.location.href='<%=request.getContextPath()%>/app/recall/admin/medical/add.jsp';
		...
		function editVO(id){
			window.location.href='<%=request.getContextPath()%>/app/recall/admin/medical/edit.jsp';
			return false;
		}
	</script>
</head>
