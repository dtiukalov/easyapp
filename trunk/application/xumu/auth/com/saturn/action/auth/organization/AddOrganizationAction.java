...
public class AddOrganizationAction implements IAction {
	...
	public IView execute(HttpServletRequest request,
		...
		if (Organization.add(organization) == 1) {
			return new JspView("/app/auth/organization/showOrganizations.jsp");
		} else {
			return new JspErrorView("添加组织结构失败");
			
		}
	}

	public String requestMapping() {
		return "/app/auth/organization/addOrganization.action";
	}
