...
insert  into `auth_re_role_resource`(`roleId`,`resourceId`) values ('super.admin','auth'),('super.admin','auth.change.password'),('super.admin','auth.organization'),('super.admin','auth.resource'),('super.admin','auth.role'),('super.admin','auth.user'),('super.admin','configuration'),('super.admin','configuration.dict'),('super.admin','website'),('super.admin','website.article'),('super.admin','website.content'),('super.admin','website.editcontent'),('super.admin','website.message');
...
insert  into `auth_re_user_resource`(`userId`,`resourceId`) values ('1','auth'),('1','auth.organization'),('1','auth.reportData'),('1','auth.reportView'),('1','auth.resource'),('1','auth.role'),('1','auth.user'),('1','configuration'),('1','configuration.dict'),('1','test'),('1','test.dict'),('1','test.highcharts.basic'),('1','test.highcharts.sameData'),('1','test.report'),('2','auth'),('2','auth.organization'),('2','auth.resource'),('2','auth.role'),('23','test'),('3','auth'),('3','auth.reportData'),('3','auth.reportView'),('3','auth.role'),('3','auth.user'),('rongzhan','auth.change.password'),('rongzhan','website'),('rongzhan','website.editcontent');
